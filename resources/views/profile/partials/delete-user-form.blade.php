{{-- resources/views/profile/partials/delete-user-form.blade.php (Versi Elegan Baru) --}}
        ...
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6 bg-white rounded-lg">
            ...
            <div class="mt-6">
                ...
                <x-text-input
                    ...
                    name="password"
                    type="password"
                    class="mt-1 block w-3/4 bg-white border-gray-300 focus:border-brand-pink focus:ring-brand-pink text-gray-900 rounded-md"
